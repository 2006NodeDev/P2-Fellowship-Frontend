...
>>>>>>> e922702f09578b165ddd5436a6efcce079aa423f


//we'll try this later if we have time
...
//         let res = await createNewLocation(name, image, realm, governance, primaryPopulation, type, description, rating, visited)        
