...
//     const [image, changeImage] = useState<LocationImage | undefined>(undefined)
//     let [realm, changeRealm] = useState("")
//     let [governance, changeGovernance] = useState("")
//     let [primaryPopulation, changePrimaryPopulation] = useState("")
//     let [description, changeDescription] = useState("")
//     let [rating, changeRating] = useState(undefined)
//     let [numVisited, changeNumVisited] = useState(undefined)
...
//     const updateLocation = async (e:SyntheticEvent) => {
...
//           </Typography>
//           <form autoComplete="off" onSubmit={updateLocation} className={classes.form} noValidate>
